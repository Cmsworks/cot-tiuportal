...
[BEGIN_COT_EXT]
Hooks=index.tags
Tags=index.tpl:{INDEX_TAG_CLOUD_MARKET},{INDEX_TAG_CLOUD_MARKET_ALL_LINK}
[END_COT_EXT]
==================== */
 ...
 * @copyright Copyright (c) CMSWorks.ru, littledev.ru,  simple-website.in.ua
 * @license BSD
 *  */


if ($cfg['plugin']['tagslance']['market'] && $cfg['plugin']['tagslance']['market_index'])
{
	...
	$t->assign('INDEX_TAG_CLOUD_MARKET', $tc_html);
	if ($cfg['plugin']['tags']['more'] && $limit > 0 && $tag_count == $limit)
	{
		$t->assign('INDEX_TAG_CLOUD_MARKET_ALL_LINK',
